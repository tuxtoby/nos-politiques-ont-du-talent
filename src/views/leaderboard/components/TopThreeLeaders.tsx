...
export const TopThreeLeaders: React.FC<TopThreeLeadersProps> = ({ leaders, onLeaderClick }) => {
            ...
            <CardContent>
              <Box sx={styles.profileBox}>
                ...
                <Box sx={styles.infoBox}>
                  ...
                  <Typography color="textSecondary" sx={styles.caption}>
                    {leader.caption}
                  </Typography>
                </Box>
                <TrophyIcon
              ...
              >
                <SentencesChip
                  count={leader.numberOfSentences}
                  size={isMobile ? 'small' : 'medium'}
                />
                <PrisonTimeChip
                  months={leader.totalPrisonTime}
                  size={isMobile ? 'small' : 'medium'}
                />
